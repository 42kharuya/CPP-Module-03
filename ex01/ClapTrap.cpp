...
void ClapTrap::showStatus() const {
	std::cout << "\n\033[34m" << "// STATUS //" << "\033[m" << std::endl;
	std::cout << "\033[34m" << "Name: " << this->_name << "\033[m" << std::endl;
	std::cout << "\033[34m" << "Hit Points: " << this->_hitPoints << "\033[m" << std::endl;
	std::cout << "\033[34m" << "Energy Points: " << this->_energyPoints << "\033[m" << std::endl;
	std::cout << "\033[34m" << "Attack Damage: " << this->_attackDamage  << "\033[m\n" << std::endl;
}
